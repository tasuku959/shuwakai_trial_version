...
if (!isset($_SESSION["user_id"])) {
    header("Location: ../5_login/login.html");
    exit;
}
?>
...
<body>
  ...
  <header>
    <div class="container">
      ...
      <div class="header-right2">  <!-- クイズ -->
        <a href="../2_quiz/quiz.html" class="notice">クイズ</a>
      </div>
      ...
      <div class="lessons">
        <div class="lesson">
          <div class="lesson-icon">
            ...
            <p></p>
            <a href="../3_classes/class.html" class="btn class_list">クラス一覧</a>
  ...
  <div id="modal" class="modal">
    <div class="modal-content">
      ...
      クラスにてご案内いたします。</p>
      <a href="../4_materials/Sign_language_materials.html" class="ok">OK</a>
    </div>
  </div>
